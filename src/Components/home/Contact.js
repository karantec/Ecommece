...
export default function ContactUs() {
  ...
  const faqs = [
    {
      question: "What products does DesiKrishi offer?",
      answer:
    ...
    {
      question: "How can I start organic farming at home?",
      answer:
        "You can start with our home garden kits which include everything you need - organic seeds, fertilizers, and growing instructions. Our team also provides guidance for beginners.",
    },
    {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow">
            ...
            <a
              ...
              className="text-xl font-bold text-gray-900 hover:text-lime-600 transition-colors"
            >
              +91 9239261803
            </a>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow">
            ...
            <a
              ...
              className="text-lg font-bold text-gray-900 hover:text-lime-600 transition-colors break-all"
            >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {faqs.map((faq, index) => (
              <div
                key={index}
                className="border border-gray-200 rounded-lg overflow-hidden hover:border-lime-500 transition-colors"
              >
                <button
                ...
                >
                  ...
                  <ChevronDown
                    className={`w-5 h-5 text-lime-600 flex-shrink-0 transition-transform ${
